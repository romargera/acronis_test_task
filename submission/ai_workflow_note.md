...
- AI initially pushed toward a bigger feature surface (too many widgets and pseudo-analytics). I cut this to decision-centric interactions only: triage heatmap, risk radar, margin leaks, and Client 360.
...
Final decision:
- Two role-focused dashboards + one shared Client 360 drill-down.
- This creates clearer workflows and a meaningful click-through path from signal to action.
